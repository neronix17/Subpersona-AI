...
{
    public class JobDriver_CarryToReconstructor : JobDriver
	{
		public const TargetIndex TakeeInd = TargetIndex.A;

		public const TargetIndex DropPodInd = TargetIndex.B;

		public Pawn Takee => (Pawn)job.GetTarget(TargetIndex.A).Thing;

		public Building_SubpersonaReconstructor DropPod => (Building_SubpersonaReconstructor)job.GetTarget(TargetIndex.B).Thing;
